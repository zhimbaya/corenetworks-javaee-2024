...
public class CocheServiceImpl implements CocheService{
	...
	public Coche eliminarCoche(String matricula) {
		Coche encontrado = buscarCoche(matricula);
		if(encontrado != null) {
	...
	@Override
	public List<Coche> buscarCoche(double precioMax) {
		return coches.stream()
	...
	@Override
	public void actualizarCoches(Coche coche) {
		Coche encontrado = buscarCoche(coche.getMatricula());
		if(encontrado != null) {
