		...
		do {
			...
			switch(opcion) {
				...
				case 3:
					...
					List<Cesta> pedidos = pedidoService.precioInferior(precioMax);
					pedidos.forEach(p->{
						System.out.println("Los producto de precio inferio son:" + p.getProducto());
					});
					break;
				case 4: 
					System.out.println("Introduza la cantidad de meses:");
					int meses=Integer.parseInt(sc.nextLine());
					List<Cesta> pedido=pedidoService.anteriores(meses);
					pedido.forEach(p-> {
